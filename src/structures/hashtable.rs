...
use crate::Natural;
use crate::{cvec, CompVector};
use crate::{search::thread_count, FResult};
...
impl HashTable {
    ...
    pub fn update(&self, sup: u64, flag: bool) -> FResult<Self> {
        ...
        for i in errors.iter().unwrap() {
            idx_set
                .insert(i.hash_shift((32 - self.dimen.trailing_zeros()) as usize, self.multiplier));
        }
    ...
    // Selects the greater value for each index
    ...
    pub fn corrector_set(
        &mut self,
        cvec: CompVector<u64>,
        integer_max: u64,
        indices: Vec<usize>,
        total: bool,
    ) -> FResult<CompVector<u64>> {
                    ...
                    'search: loop {
                        ...
                        'incsearch: for i in 0..64 {
                            ...
                            if i == 0 {
                                ...
                                bases =
                                    veccy.terminating_list_st(i * 1024, (i + 1) * 1024).unwrap();
                            }

...
pub(crate) fn filter_generic<T: FInteger, F: GenericFilter>(file: std::fs::File, utf8_flag: bool, filter_flag: bool) -> Vec<T>{
...
pub(crate) fn filter_generic_file<T: FInteger, F: GenericFilter>(file: std::fs::File, out: std::fs::File, utf8_flag: bool, filter_flag: bool){
      let mut file_in = std::io::BufReader::new(file.try_clone().unwrap());
 ...
 pub(crate) fn filter_strong<T: FInteger>(file: std::fs::File, utf8_flag: bool, filter_flag: bool,base: T) -> Vec<T>{
    let mut file_in = std::io::BufReader::new(file.try_clone().unwrap());
      let mut k = Vec::<T>::new();
